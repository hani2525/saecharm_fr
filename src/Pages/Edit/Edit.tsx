      ...
      <div className={css.container}>
        ...
        <div className={css.addBox}>
          ...
          <div className={css.dateInfo}>
            ...
            <label className={cn(css.label, css.dateLabel)}>
              <span className={css.labelName}>등반일</span>
              <DatePick />
            </label>
          ...
          <div className={css.additionalInfo}>
            ...
            <label className={cn(css.label, css.selectLabel)}>
              ...
              >
                ...
                <option value="지원석" defaultChecked>
                  지원석
                </option>
          ...
          <div className={css.buttonBox}>
            <div className={cn(css.saveButton, css.button)}>수정</div>
            <div className={cn(css.cancelButton, css.button)}>취소</div>
          </div>
        </div>
      </div>
    </>
